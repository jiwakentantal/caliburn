...
#install cf
wget https://raw.githubusercontent.com/${GitUser}/caliburn/main/install/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
...
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/caliburn/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
echo -e "\e[0;32mDONE INSTALLING SSH & OVPN\e[0m"
clear
#install ssr
echo -e "\e[0;32mINSTALLING SS & SSR...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/caliburn/main/install/ssr.sh && chmod +x ssr.sh && screen -S ssr ./ssr.sh
wget https://raw.githubusercontent.com/${GitUser}/caliburn/main/install/sodosok.sh && chmod +x sodosok.sh && screen -S ss ./sodosok.sh
echo -e "\e[0;32mDONE INSTALLING SS & SSR\e[0m"
clear
#installwg
echo -e "\e[0;32mINSTALLING WIREGUARD...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/caliburn/main/install/wg.sh && chmod +x wg.sh && screen -S wg ./wg.sh
echo -e "\e[0;32mDONE INSTALLING WIREGUARD\e[0m"
clear
#install Xray
echo -e "\e[0;32mINSTALLING XRAY CORE...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/caliburn/main/install/ins-xray.sh && chmod +x ins-xray.sh && screen -S ins-xray ./ins-xray.sh
...
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/caliburn/main/install/ohp.sh && chmod +x ohp.sh && ./ohp.sh
wget https://raw.githubusercontent.com/${GitUser}/caliburn/main/install/ohp-dropbear.sh && chmod +x ohp-dropbear.sh && ./ohp-dropbear.sh
wget https://raw.githubusercontent.com/${GitUser}/caliburn/main/install/ohp-ssh.sh && chmod +x ohp-ssh.sh && ./ohp-ssh.sh
echo -e "\e[0;32mDONE INSTALLING OHP PORT\e[0m"
clear
#install websocket
echo -e "\e[0;32mINSTALLING WEBSOCKET PORT...\e[0m"
wget https://raw.githubusercontent.com/${GitUser}/caliburn/main/websocket-python/websocket.sh && chmod +x websocket.sh && screen -S websocket.sh ./websocket.sh
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/${GitUser}/caliburn/main/nginx.conf"
mkdir -p /home/vps/public_html
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/${GitUser}/caliburn/main/vps.conf"
...
echo "1.2" > /home/ver
# Version
ver=$( curl https://raw.githubusercontent.com/${GitUser}/version-script/main/version.conf )
history -c
echo "$ver" > /home/ver
clear
echo " "
...
echo "    ----------------" | tee -a log-install.txt
echo "   - Xray Vmess Ws Tls       : 7443"  | tee -a log-install.txt
echo "   - Xray Vless Ws Tls       : 2083"  | tee -a log-install.txt
echo "   - Xray Vmess Ws None Tls  : 80"  | tee -a log-install.txt
echo "   - Xray Vless Ws None Tls  : 880"  | tee -a log-install.txt
echo "   - Xray Vmess Grpc Tls     : 8443"  | tee -a log-install.txt
echo "   - Xray Vless Grpc Tls     : 9443"  | tee -a log-install.txt
echo "   - Xray Vless Tcp Xtls     : 443"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "    [INFORMASI TROJAN]"  | tee -a log-install.txt
echo "    ------------------" | tee -a log-install.txt
echo "   - Xray Trojan Tcp Tls     : 2087"  | tee -a log-install.txt
echo "   - Xray Trojan Grpc Tls    : 8080"  | tee -a log-install.txt
echo "   --------------------------------------------------------------" | tee -a log-install.txt
echo ""  | tee -a log-install.txt
